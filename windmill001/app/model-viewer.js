...
//     this.el.sceneEl.appendChild(uploadContainerEl);
  ...
  initCameraRig: function () {
    ...
    cameraEl.setAttribute('position', '0.01 -0.1 0')
    ...
    rightHandEl.setAttribute('rotation', '0 90 90');
  ...
  initEntities: function () {
    ...
    modelEl.setAttribute('rotation', '0.6 0 0');
    // modelEl.setAttribute('animation-mixer', 'clip: step01; loop: once  ');
    // modelEl.setAttribute('shadow', 'cast: true; receive: false');

    modelPivotEl.appendChild(modelEl);

    shadowEl.setAttribute('rotation', '-80 -30 0');
...
//     arShadowEl.setAttribute('visible', 'false');
  ...
  onEnterVR: function () {
    ...
    if (!this.el.sceneEl.is('ar-mode')) {
      cameraRigEl.object3D.position.set(0.1, -1.5, 4);
    } else 
    {
